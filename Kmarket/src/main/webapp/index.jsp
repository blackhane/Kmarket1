            ...
            <aside>
                ...
                <article class="best">
					...
					<c:forEach items="${best}" var="item">
						<li>
						    <a href="/Kmarket/product/view.do?cate1=${item.cate1}&cate2=${item.cate2}">
						        <div class="thumb">
						            <i>${i}</i>
						        ...
						        <div class="dis_price">
						            <ins>${item.price - (item.price/item.discount)}원</ins>
						        </div>
						    </a>
						</li>
			...
			<section class="hit" id="hit">
				...
				<article>
					<c:forEach items="${hit}" var="item">
						<a href="/Kmarket/product/view.do?cate1=${item.cate1}&cate2=${item.cate2}">
							<div class="thumb"><img src="${item.thumb2}" alt="thumb2" /></div>
							<h2>${item.prodName}</h2>
							<p>${item.descript}</p>
							<div class="org_price">
								<del>${item.price}원</del>
